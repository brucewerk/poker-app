...
export const ACHIEVEMENTS = {
  ...
  TWO_PAIRS_WIN: {
    ...
    condition: (stats) => {
      ...
      const handsByType = stats?.handsByType || {};
      return hand === "Dois Pares" || 
             hand.includes("Dois Pares") ||
             (handsByType["Dois Pares"] || 0) >= 1;
    },
  },
  THREE_KIND_WIN: {
    id: "three_kind_win",
    ...
    condition: (stats) => {
      ...
      const handsByType = stats?.handsByType || {};
      return hand === "Trinca" || 
             hand.includes("Trinca") ||
             (handsByType["Trinca"] || 0) >= 1;
    },
  },
  STRAIGHT_WIN: {
    id: "straight_win",
    ...
    condition: (stats) => {
      const hand = stats?.bestHand || "";
      const handsByType = stats?.handsByType || {};
      return hand === "Sequencia" || 
             hand.includes("Sequencia") ||
             (handsByType["Sequencia"] || 0) >= 1;
    },
  },
  FLUSH_WIN: {
    id: "flush_win",
  ...
  FOUR_KIND_WIN: {
    ...
    condition: (stats) => {
      ...
      const handsByType = stats?.handsByType || {};
      return hand === "Quadra" || 
             hand.includes("Quadra") ||
             (handsByType["Quadra"] || 0) >= 1;
    },
  },
  STRAIGHT_FLUSH_WIN: {
    ...
    condition: (stats) => {
      ...
      return hand === "Straight Flush" || 
             hand.includes("Straight Flush") ||
             (handsByType["Straight Flush"] || 0) >= 1;
    },
  },
  ROYAL_FLUSH_WIN: {
    id: "royal_flush_win",
    ...
    condition: (stats) => {
      ...
      return hand === "Royal Flush" || 
             hand.includes("Royal Flush") ||
             (handsByType["Royal Flush"] || 0) >= 1;
    },
  },
};
